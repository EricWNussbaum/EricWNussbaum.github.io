...
In the EU, these frictions instead appear through decentralized bargaining over pool formation.
This paper develops and estimates an endogenous-network bargaining model of pool contract formation to evaluate the efficiency of the pooling mechanism relative to alternative policies.
